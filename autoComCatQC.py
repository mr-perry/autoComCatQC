...
while ( ii <= countYear ):
	...
	while ( jj <= countMag ):
		if ( jj != 0 ):
			query="http://earthquake.usgs.gov/fdsnws/event/1/count?starttime=%d-01-01T00:00:00&endtime=%d-12-31T23:59:59&minmagnitude=%1.1f&maxmagnitude=%1.1f"\
					% (Years[ii], Years[ii],Mags[jj,0],Mags[jj,1])
#			print query
		else:
			query="http://earthquake.usgs.gov/fdsnws/event/1/count?starttime=%d-01-01T00:00:00&endtime=%d-12-31T23:59:59&minmagnitude=%1.1f"\
